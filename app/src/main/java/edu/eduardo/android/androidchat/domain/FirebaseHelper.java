package edu.eduardo.android.androidchat.domain;
...
public class FirebaseHelper {
    ...
    private final static String FIRABASE_URL = "https://eduardochat.firebaseio.com/";
    ...
    public String getAuthUserEmail(){
        ...
        String email = null;
        if (authData!=null){
            Map<String, Object> prividerData = authData.getProviderData();
            email= prividerData.get("email").toString();
        }
        return email;
    }
