...
import edu.eduardo.android.androidchat.addcontact.AddContactPresenterImpl;
...
public class AddContactFragment extends DialogFragment implements AddContactView, DialogInterface.OnShowListener {
    ...
    // controlar los botones fe agregar usuario para que nno se sierren si hay un error
    @Override
        ...
        if (dialog != null){
            ...
            positiveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //si da error quitar el if
                    if (editTxtEmail.length() > 0) {
